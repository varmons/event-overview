        ...
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
                <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 max-w-md w-full text-center space-y-6">
                    ...
                    <h1 className="text-xl font-bold text-gray-900">{t('invalid.title')}</h1>
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 max-w-md w-full text-center space-y-6">
                ...
                <div>
                    <h1 className="text-xl font-bold text-gray-900 mb-2">{t('leaving')}</h1>
                    <p className="text-gray-600">{t('description')}</p>
                    <div className="mt-4 p-3 bg-gray-50 rounded-lg border border-gray-100 break-all">
                        <p className="font-mono text-sm text-blue-600 font-medium">{hostname}</p>
                    </div>
                </div>
